  ...
  try {
    ...
    const res = await fetch(delivery.url, {
      ...
      headers: {
        ...
        "User-Agent": "Clickyfied-Webhooks/1.0",
        "X-Clickyfied-Signature": `sha256=${signature}`,
        "X-Clickyfied-Timestamp": String(timestamp),
        "X-Clickyfied-Event": delivery.event,
        "X-Clickyfied-Delivery": delivery.id,
      },
