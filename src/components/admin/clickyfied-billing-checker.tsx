...
export function ClickyfiedBillingChecker({ className = "" }: { className?: string }) {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row sm:items-end gap-3 bg-slate-50/70 p-3.5 rounded-xl border border-slate-200/70 dark:bg-slate-800/40 dark:border-white/5">
        <div className="space-y-1.5 flex-1 min-w-[200px]">
          ...
          <Input
            ...
            className="h-9 font-mono text-xs bg-white dark:bg-slate-900 border-slate-200 dark:border-white/10"
          />
        </div>
        ...
        <Button
          ...
          className="h-9 px-4 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-semibold shrink-0"
        >
        ...
        <div className="space-y-4 pt-1 animate-in fade-in duration-200">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            ...
            <div className="rounded-xl border border-emerald-200 bg-emerald-50/70 p-4 dark:border-emerald-900/60 dark:bg-emerald-950/30">
              ...
              <div className="mt-2 text-2xl font-bold font-mono text-emerald-900 dark:text-emerald-200">
            ...
            {/* Total Data Volume */}
            <div className="rounded-xl border border-indigo-200 bg-indigo-50/70 p-4 dark:border-indigo-900/60 dark:bg-indigo-950/30">
              ...
              <div className="mt-2 text-2xl font-bold font-mono text-indigo-900 dark:text-indigo-200">
                {data.totalDataGb.toLocaleString()} <span className="text-sm font-normal text-indigo-600">GB</span>
              </div>
              <p className="mt-1 text-[11px] text-indigo-700/80 dark:text-indigo-400/80">
                {data.ordersCount} batch order{data.ordersCount === 1 ? "" : "s"} submitted
              </p>
            </div>

            {/* Gross Cost */}
            <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 dark:border-white/10 dark:bg-slate-800/40">
            ...
            <div className="rounded-xl border border-amber-200 bg-amber-50/70 p-4 dark:border-amber-900/60 dark:bg-amber-950/30">
              ...
              <div className="mt-2 text-2xl font-bold font-mono text-amber-900 dark:text-amber-200">
          ...
          {data.user && (
            <div className="flex flex-wrap items-center justify-between gap-2 px-3.5 py-2 rounded-xl bg-slate-100/70 border border-slate-200 text-xs text-slate-600 dark:bg-slate-800/50 dark:border-white/10 dark:text-slate-300">
              <div className="flex items-center gap-2">
          ...
          <div className="border border-slate-200 dark:border-white/10 rounded-xl overflow-hidden bg-white dark:bg-slate-900">
            <div className="flex items-center justify-between border-b border-slate-200 dark:border-white/10 bg-slate-50/70 dark:bg-slate-800/40 px-3 py-2">
                    ...
                    return (
                      <div key={ord.id} className="text-xs">
                        <div
                          ...
                          className="flex items-center justify-between p-3 cursor-pointer hover:bg-slate-50/80 dark:hover:bg-slate-800/40 transition"
                        >
                        ...
                        {isExpanded && ord.entries && ord.entries.length > 0 && (
                          <div className="bg-slate-50/80 dark:bg-slate-900/80 px-4 py-2.5 border-t border-slate-100 dark:border-white/5 space-y-1.5">
              ...
              <div className="divide-y divide-slate-100 dark:divide-white/5 max-h-[420px] overflow-y-auto">
                {data.refunds.length === 0 ? (
                  ...
                  data.refunds.map((ref) => (
                    <div
                      key={ref.id}
                      className="flex items-center justify-between p-3 text-xs hover:bg-slate-50/80 dark:hover:bg-slate-800/40 transition"
                    >
                      ...
                      <div className="font-bold font-mono text-amber-600 dark:text-amber-400 text-sm">
