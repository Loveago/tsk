              ...
              <div className="border-b border-slate-100 bg-slate-50/70 p-2.5 dark:border-white/5 dark:bg-white/5">
                <div className="relative flex items-center">
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border border-slate-200 bg-white py-1.5 pl-8 pr-7 text-xs text-slate-800 placeholder:text-slate-400 focus:border-brand-500 focus:outline-none caret-brand-600 dark:border-white/10 dark:bg-[#131d31] dark:text-slate-100 dark:placeholder:text-slate-500 dark:caret-brand-400"
                  />
                  {searchQuery && (
                    <button
                      type="button"
